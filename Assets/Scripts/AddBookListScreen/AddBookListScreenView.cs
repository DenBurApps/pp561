...
public class AddBookListScreenView : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _emptyList;
    ...
    public void ToggleEmptyListImage(bool status)
    {
        _emptyList.gameObject.SetActive(status);
    }
